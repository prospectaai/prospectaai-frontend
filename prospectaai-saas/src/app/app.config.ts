  ...
  providers: [
    ...
    importProvidersFrom(
      LucideAngularModule.pick({
        ...
        Moon, Sun, Bell, Trash, MessageCircle, LogOut, Plus, ChevronRight, Image, Layout, ShieldCheck
      })
    )
  ]
};
